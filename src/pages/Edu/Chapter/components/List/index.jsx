...
import { getLessonList,batchRemoveChapterList } from "../../redux";

import './index.less'

@withRouter
@connect((state) => ({ chapters: state.chapter.chapters }), 
{getLessonList,batchRemoveChapterList})
class List extends Component {
    ...
    batchRemove=async()=>{
        ...
        const {chapters:{items:chapters},batchRemoveLessonList}=this.props
