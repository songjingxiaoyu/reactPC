        ...
        return()=>{
            ...
            switch(datePicker){
                ...
                case 'week':
                    rangeTime=[
                        time,
                        moment(moment().add(1,'d').format(dateFormat),dateFormat)
                    ]
                    break; 
                default:
                    rangeTime=[time,time]
    ...
    render() {
        ...
        const extra=(
            <div>
                ...
                onClick={this.changeDatePicker('day')}>今日
                </Button>
                <Button
                type={datePicker==='week' ? 'link' : 'text'}
                onClick={this.changeDatePicker('week')}>本周
                </Button>
                <Button
                type={datePicker==='mouth' ? 'link' : 'text'}
                onClick={this.changeDatePicker('mouth')}>本月
                </Button>
                <Button
                type={datePicker==='year' ? 'link' : 'text'}
                onClick={this.changeDatePicker('year')}>本年
                </Button>
